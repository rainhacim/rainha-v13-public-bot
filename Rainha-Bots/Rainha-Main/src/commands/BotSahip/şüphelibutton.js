...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    client.api.channels(message.channel.id).messages.post({
      data: {
        "content": `${Jail} Aşağıda ki düğmeden hesabınızın 7 gün süresini doldurmasına kalan süresini görüntüleyebilirsiniz ve tıklayarak şüpheliden çıkabilirsiniz.`, "components": [{
          "type": 1, "components": [
