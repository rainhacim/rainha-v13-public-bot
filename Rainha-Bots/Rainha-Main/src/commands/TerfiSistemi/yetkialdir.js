...
module.exports = {
  conf: {
    aliases: ["yetki-aldır", "yetkialdır", "yetkili","yetki-ver","yetkiver"],
    name: "yetki-aldır",
    help: "yetki-aldır <@isim/ID>",
    category: "yetkili",
  },
  ...
  run: async (client, message, args, embed) => {
    ...
    .setLabel("Kabul Et")
    .setStyle("SUCCESS")
    .setEmoji("1079028516714188810"),
  
    new MessageButton()
    .setCustomId("red")
    .setLabel("Reddet")
    .setStyle("DANGER")
    .setEmoji("1083791139162832956"),
    );
...
let collector = await msg.createMessageComponentCollector({ filter, time: 60000 })
    ...
    collector.on("collect", async (button) => {
      ...
      await coin.findOneAndUpdate({ guildID: member.guild.id, userID: message.author.id }, { $inc: { coin: god.Main.yetkiCoin } }, { upsert: true });       
