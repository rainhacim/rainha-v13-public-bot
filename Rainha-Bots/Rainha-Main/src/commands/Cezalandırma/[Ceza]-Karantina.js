...
module.exports = {
  conf: {
    aliases: ["cezalı","reklam"],
    name: "cezalı",
    help: "cezalı <@isim/ID> <Sebep>",
  ...
  run: async (client, message, args, embed) => {
    ...
    if (god.Main.dmMessages) member.send({ content :`**${message.guild.name}** sunucusunda, **${message.author.tag}** tarafından, **${reason}** sebebiyle jaillendiniz.`}).catch(() => {});
