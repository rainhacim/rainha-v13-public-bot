...
module.exports = {
  conf: {
    aliases: ["kalkmazban","kalıcı-ban","kalıcıban"],
    name: "kalkmazban",
    help: "kalkmazban <@isim/ID>",
    category: "sahip",
    owner: true
  },
  ...
  run: async (client, message, args, embed) => {
    ...
    if (god.Main.dmMessages) user.send({ content :`**${message.guild.name}** sunucusundan, **${message.author.tag}** tarafından, **${reason}** sebebiyle **kalıcı olarak** banlandınız!`}).catch(() => {});
