...
run: async (client, message, args, prefix) => {
    if (!message.guild) return;
        ...
        const background = await loadImage("https://media.discordapp.net/attachments/1061350563775783004/1068114889689808926/rainha_rank.png")
        ...
        loading.delete();
        const attachment = new MessageAttachment(image.toBuffer(), 'rainha.png');
