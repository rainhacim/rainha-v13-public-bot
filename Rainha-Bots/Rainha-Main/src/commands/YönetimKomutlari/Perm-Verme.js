...
if (!uye) return message.reply({ content:` • Örnek; !perm @isim/ID`});
        ...
        .addOptions([
            {
                label: 'Vip',
                value: 'vip',
                emoji: '1123983186125402162'
            },
            {
                label: 'Müzisyen',
                value: 'müzisyen',
                emoji: '1123983188784586863'
            },						
            {
                label: 'Tasarımcı',
                value: 'tasarımcı',
                emoji: '1123983189791215848'
            },
            {
                label: 'Streamer',
                value: 'streamer',
                emoji: '1123983148716408914'
            },
            {
                label: 'Terapist',
                value: 'terapi',
                emoji: '1123983160636608534'
            },
            {
                label: 'Sorun Çözücü',
                value: 'sorun',
                emoji: '1123983159495774258'
            },
        ]),
);
    ...
    if (interaction.values[0] === "streamer") {
     ...
     if (interaction.values[0] === "terapi") {
      ...
      if(!uye.roles.cache.has(ayar.terapistRole)) {
        ...
        msg.edit({ content:`${green} Başarıyla ${uye}, isimli kişiye **Terapist** rolü verildi.`, components: [] });
      } else {
        ...
        msg.edit({ content:`${green} Başarıyla ${uye}, isimli kişinin **Terapist** rolü geri alındı.`, components: [] });
      };
   }
