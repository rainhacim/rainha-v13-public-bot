...
moment.locale("tr");
    ...
    let iltifatlar = [
      ...
      "rainha senden mesaj bekliyor ;)",
      "rainha senle evlenmek istiyormuş benden duymuş olma.",
      "rainha selam söyledi sana.",
      "rainha yanına gelmek için uçak bileti almış benden duymuş olma.",
