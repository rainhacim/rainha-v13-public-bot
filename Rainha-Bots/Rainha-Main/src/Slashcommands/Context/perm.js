...
module.exports = {
  ...
  async execute(interaction, client) {
    let uye = client.guilds.cache.get(god.GuildID).members.cache.get(interaction.targetId);
    if (!uye) return;
    ...
    if(interaction.user.id === uye.id) return interaction.reply({content: `**Kendine Rol Veremezsin!**`, ephemeral: true })
    ...
    collector.on("collect", async (interaction) => {
         ...
         if (interaction.values[0] === "vip") {
            ...
            if(!uye.roles.cache.has(ayar.vipRole)) {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Vip** adlı rol verildi.`)]})
              interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Vip** rolü verildi.`, components: [], ephemeral: true });
            } else {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Vip** adlı rol geri alındı.`)]})
         ...
         if (interaction.values[0] === "müzisyen") {
            ...
            if(!uye.roles.cache.has(ayar.müzisyenRole)) {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Müzisyen** adlı rol verildi.`)]})
              interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Müzisyen** rolü verildi.`, components: [], ephemeral: true });
            } else {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Müzisyen** adlı rol geri alındı.`)]})
        ...
        if (interaction.values[0] === "tasarımcı") {
            ...
            if(!uye.roles.cache.has(ayar.tasarımcıRole)) {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Tasarımcı** adlı rol verildi.`)]})
              interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Tasarımcı** rolü verildi.`, components: [], ephemeral: true });
            } else {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Tasarımcı** adlı rol geri alındı.`)]})
        ...
        if (interaction.values[0] === "streamer") {
            ...
            if(!uye.roles.cache.has(ayar.streamerRole)) {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Streamer** adlı rol verildi.`)]})
              interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Streamer** rolü verildi.`, components: [], ephemeral: true });
            } else {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Streamer** adlı rol geri alındı.`)]})
         ...
         if (interaction.values[0] === "terapi") {
          ...
          if(!uye.roles.cache.has(ayar.terapistRole)) {
            client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Terapist** adlı rol verildi.`)]})
            interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Terapist** rolü verildi.`, components: [], ephemeral: true });
          } else {
            client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Terapist** adlı rol geri alındı.`)]})
        ...
        if (interaction.values[0] === "sorun") {
            ...
            if(!uye.roles.cache.has(ayar.sorunçözücüRole)) {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Sorun Çözücü** adlı rol verildi.`)]})
              interaction.reply({ content:`${green} Başarıyla ${uye}, isimli kişiye **Sorun Çözücü** rolü verildi.`, components: [], ephemeral: true });
            } else {
              client.channels.cache.find(x => x.name == "rol_log").send({ embeds: [new MessageEmbed().setDescription(`${uye} isimli kişiye **${moment(Date.now()).format("LLL")}** tarihinde ${interaction.user} tarafından **Sorun Çözücü** adlı rol geri alındı.`)]})
